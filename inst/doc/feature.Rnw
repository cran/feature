...
\begin{center}
<<fig=TRUE,results=hide,print=FALSE>>=
library(feature)
data(earthquake)
...
library(MASS)
data(geyser)
featureSignif(geyser, addSignifGradRegion=TRUE, addSignifCurvRegion=TRUE, bw=c(4.5, 0.37))
@
<<fig=TRUE,print=FALSE,echo=FALSE>>=
library(MASS)
data(geyser)
featureSignif(geyser, addSignifGradRegion=TRUE, addSignifCurvRegion=TRUE, bw=c(4.5, 0.37),gridsize=c(51,51))
@
...
\begin{center}
<<eval=FALSE>>=
fs <- featureSignif(geyser, addSignifGradData=TRUE, addSignifCurvData=TRUE, bw=c(4.5, 0.37))
@
<<fig=TRUE,echo=FALSE,print=FALSE>>=
fs <- featureSignif(geyser, addSignifGradData=TRUE, addSignifCurvData=TRUE, bw=c(4.5, 0.37), gridsize=c(51,51))
@
...
\bibitem[Duong et~al., 2006]{duong06}
