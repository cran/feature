...
library(MASS)
data(geyser)
featureSignif(geyser, addSignifCurvRegion=TRUE, bw=c(4.5, 0.37))
@
<<fig=TRUE,print=FALSE,echo=FALSE>>=
library(MASS)
data(geyser)
fs <- featureSignif(geyser, addSignifCurvRegion=TRUE, bw=c(4.5, 0.37),gridsize=c(51,51))
@
\end{center}
...
\begin{center}
<<eval=FALSE>>=
fs <- featureSignif(geyser, addSignifCurvData=TRUE, bw=c(4.5, 0.37))
@
<<fig=TRUE,echo=FALSE,print=FALSE>>=
fs <- featureSignif(geyser, addSignifCurvData=TRUE, bw=c(4.5, 0.37), gridsize=c(51,51))
@
